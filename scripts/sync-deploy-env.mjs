  ...
  if (target === "vercel-customer") {
    ...
    return {
      ...
      values: {
        ...
        VITE_PAYFAST_MERCHANT_ID: source.VITE_PAYFAST_MERCHANT_ID,
        VITE_PAYFAST_MERCHANT_KEY: source.VITE_PAYFAST_MERCHANT_KEY,
        VITE_PAYFAST_PASSPHRASE: source.VITE_PAYFAST_PASSPHRASE,
        VITE_PAYFAST_MODE: source.VITE_PAYFAST_MODE || "live",
  ...
  if (target === "vercel-admin") {
    ...
    return {
      ...
      values: {
        ...
        VITE_ADMIN_AUTH0_REDIRECT_URI: `${PROD.adminAppUrl}/admin/callback`,
